...
<body style="font-family: poppins;">
	<style type="text/css">
     ...
     <div class="mail-body" style="padding: 20px 50px;
			...
			border: 1px solid #ddd;
			border-radius: 10px;">
     	<h4>Hi,<?php echo $mail_data['name'];?></h4>
     	 <p>You have successfully booked your therapy session with [<?php echo $mail_data['consultant_name'];?>]. Here are your session details: </p>
     	 <ul>
