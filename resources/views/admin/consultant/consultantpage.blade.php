                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col-sm-5">
                                   <a href="{{route('create-consultant')}}"> <button data-bs-toggle="modal" data-bs-target=""
                                    ...
                                    <tbody>
                                         @foreach ($datas as $data)
                                            <tr>
                                                <td>{{ $data->name }}</td>
                                                <td>
                                                    <img src="{{asset('images/consultant')}}/{{$data->photo}}" alt="contact-img" title="contact-img" class="rounded me-3" height="48" />
                                                ...
                                                <td class="table-action">
                                                    <a
                                                        href="{{route('edit-consultant',['id'=>$data->id])}}" class="action-icon"> <i
                                            ...
                                            <div id="editTestimonial{{ $data->id }}" class="modal fade" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{route('consultant.update', [$data->id])}}" method="POST"
                                            ...
                                            <div id="deleteTestimonial{{ $data->id }}" class="modal fade" tabindex="-1"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{ route('consultant.destroy', [$data->id]) }}" method="POST"
                                                            enctype="multipart/form-data" autocomplete="off">
                                                            @csrf @method('DELETE')
                                                            <input type="hidden" name="id" value="{{ $data->id }}">
